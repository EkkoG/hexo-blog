...
![](https://i.imgur.com/QIFBW5n.jpg)

### 设置触发器

触发器设置，这里我们设置衣每 5 分钟检查一次，有更新就开始构建，无更新则忽略。这个定时器的语法可以点输入框后的问号看到介绍。

![](https://i.imgur.com/jYRHm3j.jpg)

### 设置构建脚本

构建脚本设置

![](https://i.imgur.com/bx2upDq.jpg)
